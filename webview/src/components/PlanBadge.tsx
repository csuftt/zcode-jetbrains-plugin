 ...
 * Kotlin 按 providerId 标记 plan（coding-plan=个人、start-plan=体验；
 * team=客户端选中团队套餐，与个人共用同一条 providerId，见 issue #8），徽章区分展示。
...
export function PlanBadge({ plan }: { plan?: 'personal' | 'trial' | 'team' }) {
