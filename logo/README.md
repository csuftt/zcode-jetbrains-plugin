...
| 代码符号 `</>` | 编程工具身份 | 右下角两尖括号夹一条斜线，白色 26px 圆头粗线，位置 (580~880, 515~715)；与顶杠圆点共同构成"窗口 + 代码"的 GUI 叙事 |
...
像素块坐标：`x = 244 + 30×列`、`y = 242 + 42×行`，块 26×36，白色按行 `fill-opacity = 1 - 行/24`；代码符号：`<` M660 540 L580 615 L660 690、`>` M800 540 L880 615 L800 690、`/` M732 515 L748 715，均 stroke 26 圆头。
